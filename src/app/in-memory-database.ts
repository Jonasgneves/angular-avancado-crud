...
export class InMemoryDatabase implements InMemoryDbService {
  createDb(reqInfo?: import('angular-in-memory-web-api').RequestInfo): {} | import('rxjs').Observable<{}> | Promise<{}> {
      ...
      const entries: Entry[] = [
        { id: 1, name: 'Gás de cozinha', categoryId: categories[2].id, category: categories[2], paid: true, date: '14/10/2018', amount: '70,80', type: 'expense', description: 'Qualquer descrição' } as Entry,
        ...
        { id: 6, name: 'Steam Jogo', categoryId: categories[0].id, category: categories[0], paid: true, date: '06/07/2019', amount: '80,90', type: 'expense' } as Entry,
        ...
        { id: 8, name: 'Cinema', categoryId: categories[0].id, category: categories[0], paid: true, date: '01/09/2020', amount: '42,75', type: 'expense' } as Entry,
