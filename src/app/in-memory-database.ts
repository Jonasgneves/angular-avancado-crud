...
export class InMemoryDatabase implements InMemoryDbService {
  createDb(reqInfo?: import('angular-in-memory-web-api').RequestInfo): {} | import('rxjs').Observable<{}> | Promise<{}> {
      ...
      const entries: Entry[] = [
        ...
        { id: 6, name: 'Video Game Filha', categoryId: categories[2].id, category: categories[2], paid: true, date: '06/07/2019', amount: '80,90', type: 'expense' } as Entry,
        { id: 7, name: 'Uber', categoryId: categories[0].id, category: categories[0], paid: false, date: '24/07/2019', amount: '29,99', type: 'expense' } as Entry,
        { id: 8, name: 'Aluguel', categoryId: categories[0].id, category: categories[0], paid: true, date: '01/09/2020', amount: '42,75', type: 'expense' } as Entry,
        { id: 10, name: 'Gás de Cozinha', categoryId: categories[1].id, category: categories[1], paid: false, date: '09/10/2020', amount: '16,70', type: 'expense' } as Entry,
        { id: 12, name: 'Pagamento Projeto XYZ', categoryId: categories[4].id, category: categories[4], paid: false, date: '16/04/2020', amount: '62,80', type: 'expense' } as Entry,
        { id: 15, name: 'Aluguel do Filme', categoryId: categories[2].id, category: categories[2], paid: false, date: '12/02/2020', amount: '27,00', type: 'revenue' } as Entry
      ]
